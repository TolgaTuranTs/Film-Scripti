...
<div class="wrapper">
    <div class="container">
        ...
        <?php } ?>
        <!--#Başarılı ve Hatalı Bilgi Mesajları -->
        <!-- Sayfa Kaydetme Formu -->
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    <h4 class="header-title m-t-0 m-b-30">Sayfa Ekleme Formu</h4>
                    <div class="row">
                        <?php echo form_open('Cms/Sayfa/ekle'); ?>
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-12">
                            <fieldset class="form-group">
                                <label for="exampleInputEmail1">Sayfa Başlığı</label>
                                <input type="text" name="sayfa_baslik" class="form-control" id="exampleInputEmail1" value=""">
                            </fieldset>
                            <fieldset class="form-group">
                                <label for="exampleInputEmail1">Sayfa Etiketleri</label>
                                <input class="form-control" data-role="tagsinput" name="sayfa_etiket" id="exampleInputEmail1" rows="3" />
                            </fieldset>
                            <fieldset class="form-group">
                        ...
                        <button style="width:100%;height:45px" type="submit" class="btn btn-danger waves-effect waves-light">Sayfayı Kaydet</button>
                        <?php echo form_close(); ?>
                    </div>
                </div>
            </div>
