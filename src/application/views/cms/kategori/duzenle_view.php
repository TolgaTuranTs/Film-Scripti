        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <?php echo form_open('Cms/Kategori/duzenle/'.$id.''); ?>
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-12">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input class="form-control" data-role="tagsinput" name="kategori_etiket" id="exampleInputEmail1" value="<?php echo $kategori->kategori_etiket; ?>" rows="3" />
                            </fieldset>
                        </div>
